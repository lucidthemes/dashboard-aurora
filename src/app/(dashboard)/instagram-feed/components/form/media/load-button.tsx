...
export default function InstagramFeedFormMediaListLoadButton({
  fetchNextPage,
  isFetchingNextPage,
}: {
  fetchNextPage: (
    options?: FetchNextPageOptions | undefined,
  ) => Promise<InfiniteQueryObserverResult<InfiniteData<InstagramFeedFormMedia | undefined, unknown>, Error>>;
