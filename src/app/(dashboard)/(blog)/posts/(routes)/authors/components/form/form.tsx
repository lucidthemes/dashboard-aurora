...
interface PostsAuthorsFormProps {
  form: UseFormReturn<PostsAuthorsForm>;
  onSubmit: (data: PostsAuthorsForm) => Promise<void>;
  formId: string;
}

export default function PostsAuthorsForm({ form, onSubmit, formId }: PostsAuthorsFormProps) {
  return (
