...
interface PostsCategoriesFormProps {
  form: UseFormReturn<PostsCategoriesForm>;
  onSubmit: (data: PostsCategoriesForm) => Promise<void>;
  formId: string;
}

export default function PostsCategoriesForm({ form, onSubmit, formId }: PostsCategoriesFormProps) {
  return (
