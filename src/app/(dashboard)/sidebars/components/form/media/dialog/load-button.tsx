...
export default function SidebarsFormWidgetMediaDialogListLoadButton({
  fetchNextPage,
  isFetchingNextPage,
}: {
  fetchNextPage: (
    options?: FetchNextPageOptions | undefined,
  ) => Promise<InfiniteQueryObserverResult<InfiniteData<SidebarsFormWidgetMedia | undefined, unknown>, Error>>;
